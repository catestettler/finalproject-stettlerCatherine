...
class Second(object):
    ...
    def second_choice(self):
        ...
        if player_choice == 'y':
            ...
            print("A dog crate?")
            print("Holy sh*t, is that a kid in there?!")
            ...
            print(
                "The other child has been put to work with a pair of bellows, fanning the flames of the large cast-iron"
                " oven.")
            print(
                "The old man - who you are now assuming is a witch - is leafing through a large, worn book,"
